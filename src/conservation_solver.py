...
def compute_A_out(U_n, k_max=100, tol=1.0e-7):
	...
	F_half_21 = F_from_equation(U_half_21, x21)
	S_half_21 = S_from_equation(U_half_21, x21)
	F_half_10 = F_from_equation(U_half_10, x10)
	S_half_10 = S_from_equation(U_half_10, x10)
